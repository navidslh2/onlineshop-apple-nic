...
const Register = () => {
  ...
  const registerHandler = async (e: React.FormEvent) => {
    ...
    if (
      ...
      setError("رمز عبور باید حداقل 6 حرف و شامل حروف کوچک ، بزرگ و عدد باشد");
      return;
    } else if (password !== repeatPassword) {
      setError("رمز عبور و تکرار رمز عبور همخوانی ندارد");
      return;
    }
  ...
  return (
    <div className="mt-15 flex flex-col gap-8">
      ...
      <form
        className="flex flex-col gap-5 m-auto w-full max-w-xl "
        onSubmit={registerHandler}
      >
        <TextTitle className="m-auto text-md">ثبت نام</TextTitle>
